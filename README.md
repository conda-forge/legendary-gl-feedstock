...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/legendary-gl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14014&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/legendary-gl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `legendary-gl` can be installed with:

```
conda install legendary-gl
```

It is possible to list all of the versions of `legendary-gl` available on your platform with:
